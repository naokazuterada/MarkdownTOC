...
"""
    ...
    def test_markdown_preview_github(self):
        toc = self.init_update(self.markdown_preview_text.format('markdown_preview=github'))['toc']
        ...
        self.assert_In('- [пример russian][%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80-russian]', toc)
        self.assert_In('- [ПРИМЕР RUSSIAN][%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80-russian-1]', toc)

    # the other values...
    def test_markdown_preview_othervalues(self):
        toc = self.init_update(self.markdown_preview_text.format('markdown_preview=othervalues'))['toc']
        self.common_markdown_preview(toc)
...
"""
    ...
    def test_markdown_preview_no_heading_github(self):
        toc = self.init_update(self.markdown_preview_no_heading_text.format('markdown_preview=github'))['toc']
        self.assert_NotIn('^- ', toc)