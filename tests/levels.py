...
"""
    ...
    def test_levels_default(self):
        """Default is no limit"""
        toc = self.init_update(self.levels_text.format(''))['toc']
        self.appear_all_headings(toc)

    def test_levels_1(self):
        """levels="1" shows h1 """
        toc = self.init_update(self.levels_text.format('levels="1"'))['toc']
        self.assert_In('- heading 1', toc)
    ...
    def test_levels_1_2(self):
        ...
        toc = self.init_update(self.levels_text.format('levels="1,2"'))['toc']
        self.assert_In('- heading 1', toc)
        self.assert_In('- heading 2', toc)
        self.assert_NotIn('- heading 3', toc)
        self.assert_NotIn('- heading 4', toc)
    ...
    def test_levels_1_2_3(self):
        ...
        toc = self.init_update(self.levels_text.format('levels="1,2,3"'))['toc']
        self.assert_In('- heading 1', toc)
        self.assert_In('- heading 2', toc)
        self.assert_In('- heading 3', toc)
        self.assert_NotIn('- heading 4', toc)
    ...
    def test_levels_1_2_3_4(self):
        ...
        toc = self.init_update(self.levels_text.format('levels="1,2,3,4"'))['toc']
        self.assert_In('- heading 1', toc)
        self.assert_In('- heading 2', toc)
        self.assert_In('- heading 3', toc)
        self.assert_In('- heading 4', toc)
    ...
    def test_levels_1_2_3_4_5(self):
        ...
        toc = self.init_update(self.levels_text.format('levels="1,2,3,4,5"'))['toc']
        self.assert_In('- heading 1', toc)
        self.assert_In('- heading 2', toc)
        self.assert_In('- heading 3', toc)
        self.assert_In('- heading 4', toc)
    ...
    def test_levels_1_2_3_4_5_6(self):
        """levels="1,2,3,4,5" shows h1,h2,h3,h4,h5 """
        toc = self.init_update(self.levels_text.format('levels="1,2,3,4,5,6"'))['toc']
        self.appear_all_headings(toc)
